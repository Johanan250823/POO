...
public class Admin_Principal extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Admin_Principal.class.getName());
    ...
    private void initComponents() {
        ...
        JLBLInventari.setText("Inventarios");
        JLBLInventari.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        JLBLInventari.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                JLBLInventariMouseClicked(evt);
            }
        });

        JBLEmpleados.setText("Empleados");
        JBLEmpleados.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        JBLEmpleados.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                JBLEmpleadosMouseClicked(evt);
            }
        });
    ...
    //Codigo Donde se encuentra la accion de los botones 
    ...
    private void JLBLInventariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JLBLInventariMouseClicked
        // TODO add your handling code here:
        cambiarPantalla(new Inventarios());
    }//GEN-LAST:event_JLBLInventariMouseClicked

    private void JBLEmpleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JBLEmpleadosMouseClicked
        // TODO add your handling code here:
        cambiarPantalla(new Empleados());
        
    }//GEN-LAST:event_JBLEmpleadosMouseClicked

    private void JBLDashboardMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JBLDashboardMouseClicked
        // TODO add your handling code here:
        cambiarPantalla(new Dashboard_Finanza());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Admin_Principal().setVisible(true));
    }
